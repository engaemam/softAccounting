...
@section('content')
    ...
    {{--Get Devices--}}
    <script>
         $("#maindiv").on("keyup", "#all", function () {
            var src = document.getElementById("all"),
                dst = document.getElementById("No1");
...
<script type="text/javascript">
    <?php for($i = 1 ; $i <= 10 ; $i ++) {?>
    function changeClass2<?php echo $i;?>() {
        document.getElementsByClassName('Number<?php echo $i;?>')[0].className = "form-control colorr Number<?php echo $i;?> !important";
        document.getElementsByClassName('Price<?php echo $i;?>')[0].className = "form-control colorr Price<?php echo $i;?> !important";
