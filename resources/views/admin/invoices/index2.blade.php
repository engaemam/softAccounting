...
{{--                    <th>{{trans('admin.delete')}}</th>--}}
                ...
                @if($invoices->count()>0)
                    @foreach($invoices as $invoice)
                        ...
                        <tr>
                            <td>{{$invoice->id}}</td>
{{--                            <td><a href="{{aurl('invoices/show/'.$invoice->id)}}" >{{$invoice->invoice_number}}</a></td>--}}
                            <td>{{$invoice->date}}</td>
                            ...
                            {{--@else--}}
                                {{--<a href="{{aurl('invoices/addtaxs/'.$invoice->id)}}" class="btn btn-warning" > <i class="fa fa-plus"></i> </a>--}}
