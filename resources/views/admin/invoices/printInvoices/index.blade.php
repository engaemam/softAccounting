...
@section('content')
    ...
    <div class="row no-print pull-left" style="margin-top: 0px">
        <div class="col-xs-12">
            <a onclick="display1()" class="btn btn-success btn-lg"><i class="fa fa-print"></i> طباعة</a>
        </div>
    </div>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                ...
                <h2 class="page-header pull-left">
                    ...
                    <h2 class="page-header ">
                        <small class="pull-right"><b>{{trans('invoices.service_phone')}} </b> :  {{setting()->service_phone}}<br></small>
                        <small class="pull-right"><b>{{trans('invoices.invoices_number')}} </b> :  {{$invoices->id}}<br></small><br>
                    </h2>
