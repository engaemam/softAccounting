...
@section('content')
    ...
    <div class="box">
        ...
        <!-- /.box-header -->
        <div class="col-md-6">
            <a href="{{aurl('invoices/create')}}" class="btn btn-info btn-lg btn-block" style="margin-bottom: 20px">{{trans('clients.create')}}</a>
        </div>
        <div class="col-md-6">
        <br><br><br><br>
            <!-- Modal -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control select2" name="client_id" required>
                                <option class="form-control" value="">-----اختيار اسم الزبون ----</option>
                                @foreach ($clients as $client )
                                    <option value="{{$client->id}}" @if($client->id == $IdofClient ) selected @endif>{{ $client->name_client }} </option>
                                @endforeach
                        ...
                        <div class="col-sm-3">
                            <select name="invoice_type" class="form-control select2" required>
                                <option value="">   -----   اختيار نوع الفاتورة     ----- </option>
                                    ...
                                    <option value="0">فاتورة بيع</option>
                                    <option value="1">فاتورة بيع مباشر</option>
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <select name="shipping_costs" id="shippingCosts" class="form-control select2" required>
