@extends('admin.index')
@section('page_title')
    استعراض مواصفة 1  (سوق النوارس)
@endsection
@section('content')

    <div class="box">
        <div class="box-header">
            <h3 class="box-title">استعراض مواصفة 1  (سوق النوارس)</h3>
        </div>
        <div class="box-header">
            <div class="col-md-2">
                <a href="{{url('admin/Item_color_api/create')}}" class="btn btn-primary"> <i class="fa fa-plus"></i> اضافة مواصفة جديدة </a>
            </div>
            {{--<div class="col-md-5">--}}
                {{--<form method="get" action="{{url('admin/Item_color')}}" >--}}
                ...
                @if($colors->count()>0)
                    @foreach($colors as $key=>$colors)
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('admin/Item_color_api/'.$colors->id.'/edit')}}" class="btn btn-info"> <i class="fa fa-edit"></i> </a></td>
                            {{--<td>--}}
                                ...
                                {{--<div id="del_colors{{ $colors->id }}" class="modal fade" role="dialog">--}}
                                    {{--<div class="modal-dialog">--}}
                                        ...
                                        {{--<div class="modal-content">--}}
                                            ...
                                            {{--</div>--}}
                                            {{--<form method="POST" action="{{url('admin/Item_color_api/destroy')}}/{{$colors->id}}" accept-charset="UTF-8">--}}
                                                {{--{!! csrf_field() !!}--}}
                                                {{--<input name="_method" type="hidden" value="DELETE">--}}

                                                {{--<div class="modal-body">--}}
                                                    {{--<h4>{{ trans('admin.delete_this',['name'=>$colors->name_ar]) }}</h4>--}}
                                                {{--</div>--}}
