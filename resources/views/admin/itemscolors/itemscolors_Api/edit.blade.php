...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">تعديل  مواصفة 1  (سوق النوارس)
            </h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <form class="form-horizontal" method="POST" action="{{url('admin/Item_color_api/')}}/{{$colors->id}}"  enctype="multipart/form-data">
