...
@section('content')
    ...
    <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <form class="form-horizontal" method="POST" action="{{url('admin/social/')}}/{{$links->id}}"  enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="link" class="form-control" value="{{$links->name}}"  id="" placeholder="{{trans('social.social_name')}}">
                        </div>
                    </div>
{{--                    <div class="form-group">--}}
{{--                        <label for="specifications" class="col-sm-1 control-label">{{trans('social.specifications')}}</label>--}}
{{--                        <div class="col-sm-10">--}}
