...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Create New PDF : {{$invoices->invoice_number}}</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <form class="form-horizontal" method="POST" action="{{url('admin/invoices/stoneGetPdf')}}/{{$invoices->id}}"  enctype="multipart/form-data">
