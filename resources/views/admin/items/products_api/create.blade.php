...
@section('content')
    ...
    <form method="POST"  action="{{route('admin.products_api.store')}}" enctype='multipart/form-data' >
     {{ csrf_field() }}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group {{ $errors->has('ar_title') ? ' has-error' : '' }}">
                    ...
                    <input class="form-control" value="{{old('ar_title')}}" name="ar_title" type="text" id="name">
              ...
              <div class="row">
                <div class="col-xs-12 form-group {{ $errors->has('en_title') ? ' has-error' : '' }}">
                    ...
                    <input class="form-control" value="{{old('en_title')}}" name="en_title" type="text" id="name">
                    <span id="error_name"></span>
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group {{ $errors->has('code') ? ' has-error' : '' }}">
                    ...
                    <input class="form-control" value="{{old('code')}}" name="code" type="text" >
                    <span id="error_name"></span>
                    <p class="help-block"></p>
                    @if($errors->has('code'))
                        <p class="help-block">
            ...
            <div class="row">
                <div class="col-xs-12 form-group {{ $errors->has('brand') ? ' has-error' : '' }}">
                    ...
                    <input class="form-control" value="{{old('brand')}}" name="brand" type="text" id="name" >
                    <span id="error_name"></span>
                    <p class="help-block"></p>
                    @if($errors->has('brand'))
                        <p class="help-block">
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <select class="form-control select2 color"  name="color_id[]" multiple="" id="color_id" >
                        ...
                        @foreach($color as $colors)
                            <option value="{{$colors->simple_accounting_id}}"> {{$colors->name_ar}}</option>
                        @endforeach
                    </select>
                    <span id="error_name"></span>
                    <p class="help-block"></p>
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <select class="form-control select2 size"  name="size_id[]" multiple="" id="size_id" >
                        ...
                        @foreach($size as $sizes)
                            <option value="{{$sizes->simple_accounting_id}}"> {{$sizes->name_ar}}</option>
                        @endforeach
            ...
            <div class="row">
                <div class="col-xs-12 form-group {{ $errors->has('price') ? ' has-error' : '' }}">
                   <label for="price" class="control-label"> سعر المنتج  *</label>
                    <input class="form-control" value="{{old('price')}}" name="price" type="text" id="price">
                    <p class="help-block"></p>
                    @if($errors->has('price'))
                        <p class="help-block">
                            {{ $errors->first('price') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group {{ $errors->has('discount') ? ' has-error' : '' }}">
                   <label for="discount" class="control-label"> هل هناك خصم علي المنتج ؟ اذا لم يكن هناك خصم فضع صفر    *</label>
                    <input class="form-control" value="" type="number" name="discount" type="text" id="discount">
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group {{ $errors->has('price_after_discount') ? ' has-error' : '' }}">
                   <label for="price_after_discount" class="control-label">  سعر المنتج بعد الخصم  *</label>
                    <input class="form-control" value="{{old('price_after_discount')}}" name="price_after_discount" type="text" id="price_after_discount">
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group {{ $errors->has('point') ? ' has-error' : '' }}">
                   <label for="point" class="control-label">  نقاط المنتج   *</label>
                    <input class="form-control" value="{{old('point')}}" name="point" type="number" >
                    <p class="help-block"></p>
                    @if($errors->has('point'))
                        <p class="help-block">
                            {{ $errors->first('point') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group  {{ $errors->has('active') ? ' has-error' : '' }} ">
                <label for="active" class="control-label"> الحالة :   *</label> <br>
                          <input type="radio" name="active" value="1" checked /> <i class="fa fa-thumbs-o-up"></i>  مفتوح 
            ...
            <div class="row">
                <div class="col-xs-12 form-group  {{ $errors->has('fet') ? ' has-error' : '' }} ">
                <label for="fet" class="control-label"> منتج مميز ؟ :   *</label> <br>
                          <input type="radio" name="fet" value="1" checked /> <i class="fa fa-thumbs-o-up"></i>  مفتوح 
            ...
            <div class="row">
                <div class="col-xs-12 form-group  {{ $errors->has('stock') ? ' has-error' : '' }} ">
                <label for="stock" class="control-label"> هل المنتج متاح بالمخازن ؟ :   *</label> <br>
                          <input type="radio" name="stock" value="1" checked /> <i class="fa fa-thumbs-o-up"></i>  مفتوح 
             ...
             <div class="row">
                ...
                <label for="ar_body" class="control-label"  rows="30" cols="50">{{trans('admin.products.ar_body')}} *</label>
                    <textarea class="form-control " name="ar_body">{{old('ar_body')}}</textarea>
                           <p class="help-block"></p>
             ...
             <div class="row">
                ...
                <label for="en_body" class="control-label"  rows="30" cols="50">{{trans('admin.products.en_body')}} *</label>
                    <textarea class="form-control " name="en_body">{{old('en_body')}}</textarea>
                           <p class="help-block"></p>
    ...
    <input type="submit" name="submit" value="{{trans('admin.products.save')}}" class="btn btn-primary" > 
    ...
    <script type="text/javascript">
        let price = document.getElementById('price'),
            ...
            price_after_discount =  document.getElementById("price_after_discount");

            discount.onkeyup = function(){
                price_after_discount.value = eval(price.value - (price.value * discount.value) / 100 );
            }
            
      const select_cat = document.getElementById('select_cat');  
      
      select_cat.onchange = function (e) {
           $(`#${e.target.value}`).siblings().css({ display: 'none'});
