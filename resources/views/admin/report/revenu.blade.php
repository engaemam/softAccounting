...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <div class="col-md-5">
                <form method="get" action="{{aurl('revenu/monthly').'/'.request()->route('id')}}">
        ...
        <div class="box-body">
            <table  id=""  class="table table-bordered table-striped ">
                <thead>
                <tr>
                    <th>إجمالي فاتورة بيع </th>
                    <th>إجمالي فاتورة شراء </th>
                    <th>إجمالي مصاريف الشركه </th>
                    <th>إجمالي الشحن </th>
                    <th>إجمالي صافي الأرباح</th>
