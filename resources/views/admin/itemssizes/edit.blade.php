...
@section('content')
    ...
    <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <form class="form-horizontal" method="POST" action="{{url('admin/itemssizes/')}}/{{$sizes->id}}"  enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control" value="{{$sizes->name}}"  id="" placeholder="اسم المواصفة">
                        </div>
                    </div>
