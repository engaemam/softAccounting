...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-header">
            @if(in_array(86, $temp))
            <div class="col-md-2">
                <a href="{{aurl('projectcosts/create')}}" class="btn btn-primary"> <i class="fa fa-plus"></i> {{trans('projectcosts.create')}} </a>
            </div>
            @endif
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            ...
            @if($projectcosts->count()>0)
                <div class="row">
                    <div class="col-md-5 col-sm-3 ">{{trans('devices.no')}}{{$projectcosts->total()}} </div>
                    <div class="col-md-7 col-sm-7">{{$projectcosts->links()}}</div>
                </div>
            @endif
        </div>
        <!-- /.box-body -->
