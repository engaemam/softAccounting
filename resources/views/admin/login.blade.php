...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{url('/')}}/asst/plugins/iCheck/square/blue.css">
...
{{--        <img src="{{url('/')}}/js/logo.png" class="user-image" alt="User Image" style="width: 85%;">--}}
        <img  src="{{url('asst_ar/img/logo.png')}}"  width="200" height="200" alt="" />
        {{--<a href=""><b>soft Accounting</b> - Control</a>--}}
    </div>
    <!-- /.login-logo -->
