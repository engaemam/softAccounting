...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Edit  PDF : {{$Invoicespdfs->bills->bill_number}}</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <form class="form-horizontal" method="POST" action="{{url('admin/bills/updategetpdf')}}/{{$Invoicespdfs->id}}"  enctype="multipart/form-data">
