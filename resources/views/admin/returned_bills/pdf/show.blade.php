...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <div class="col-md-2">
                <a href="{{aurl('bills')}}" class="btn btn-primary"> <i class="fa fa-backward"></i> {{trans('العودة لفواتير الشراء ')}} </a>
            </div>
            <div class="col-md-2">
                <a href="{{aurl('bills/createGetPdf/')."/".$id}}" class="btn btn-warning"> <i class="fa fa-plus"></i> {{trans('إضافة جديد ')}} </a>
            </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <table  id=""  class="table table-bordered table-striped ">
                ...
                @if($Invoicespdfs->count()>0)
                    @foreach($Invoicespdfs as $bill)
                        ...
                        <tr>
                            <td>{{$bill->id}}</td>
                            <td><a href="{{ url("upload/bills/$bill->pdf")}}" target="_blank">{{$bill->pdf}}</a></td>



                            <td><a href="{{aurl('bills/editgetpdf/'.$bill->id)}}" class="btn btn-info"> <i class="fa fa-edit"></i> </a></td>
                                ...
                                <div id="del_items{{ $bill->id }}" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{url('admin/bills/destroypdf/')}}/{{$bill->id}}" accept-charset="UTF-8">
                                                {!! csrf_field() !!}
