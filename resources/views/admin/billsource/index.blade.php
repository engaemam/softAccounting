...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-header">
            <div class="col-md-2">
                    <a href="{{aurl('sources/create')}}" class="btn btn-primary"> <i class="fa fa-plus"></i> {{trans('sources.create')}} </a>
            </div>
            <div class="col-md-5">
                <form method="get" action="{{aurl('sources')}}" >
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="POST" action="{{url('admin/sources/')}}/{{$sources->id}}" accept-charset="UTF-8">
                                                    ...
                                                    <div class="modal-body">
                                                        <h4>{{ trans('admin.delete_this',['name'=>$sources->sources_name]) }}</h4>
                                                    </div>
