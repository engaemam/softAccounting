...
@section('content')
    ...
    <a href="{{ aurl('imports') }}" class="btn btn-primary no-print">Back</a>
    <!-- Main content -->
    <section class="invoice">
        ...
        <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
                <b>{{trans('imports.number')}} #{{$bills->number}}</b><br>
                <br>
            ...
            <div class="col-sm-4 invoice-col">
                <b>{{trans('bills.price_before_doller')}}</b> : {{$bills->price_doller}}<br>
                <br>
                    ...
                    <table class="table">
                      <tr class="cprint">
                        ...
                        <tr>
                            ...
                            @if(!$rate )
                                <td>{{@$bills->total_final_bill_egy}} {{@trans('EGY')}} </td>
                            @else
                                <td>{{$rate->rate * @$bills->total_final_bill_egy }} {{$rate->currencytorate->currency_name}}</td>
                            @endif
                        </tr>
                        ...
                        <tr>
                            ...
                            @if(!$rate )
                                <td>{{$z  =  $bills->total_final_bill_egy + $bills->total_import_egy}}  {{@trans('EGY')}} </td>
                            @else
                                <td>{{$rate->rate * ($bills->total_final_bill_egy+$bills->total_import_egy) }} {{$rate->currencytorate->currency_name}}</td>
                            @endif
                        </tr>
                    </table>
                </div>
